...
// Klarifai brand tokens — extracted from live klarifai.nl CSS (2026-04-15)
const NAVY = '#040026'; // page background — Klarifai Indigo
const NAVY_DEEP = '#000319'; // deepest shade for geometric backdrop
// Container gradient — exact match for klarifai.nl card background:
//   linear-gradient(180deg, rgb(4, 0, 38) 0%, rgb(8, 0, 84) 100%)
const CONTAINER_GRADIENT = 'linear-gradient(180deg, #040026 0%, #080054 100%)';
const CONTAINER_BORDER = 'rgba(53, 59, 102, 0.55)'; // #353b66 at subtle opacity
const GOLD_GRADIENT = 'linear-gradient(180deg, #e1c33c 0%, #fdf97b 100%)';
const GOLD_LIGHT = '#fdf97b';
const GOLD_MID = '#e1c33c';
const TEXT_ON_NAVY = '#fefefe';
const TEXT_MUTED_ON_NAVY = '#898999'; // klarifai.nl muted body colour
...
/**
 * Top-left brand chrome: Klarifai icon alone (for now).
 *
 ...
 */
function BrandChrome({ prospect: _prospect }: { prospect: BrochureProspect }) {
  return (
    <div
      style={{
        position: 'fixed',
